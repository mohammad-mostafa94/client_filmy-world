            ...
            <div className="row justify-content-between align-items-center">
                ...
                <div className="col-xl-5 col-lg-5 col-md-9 p-4">
                    ...
                    <div className="d-flex justify-content-between">
                        ...
                        <a className="btn text-danger fw-bolder" href={"https://www.youtube.com/watch?v=" + trailer} rel="noreferrer" target="_blank"><i className="bi bi-caret-right-square-fill"></i>Play Trailer</a>
                    </div>
                    <div>
